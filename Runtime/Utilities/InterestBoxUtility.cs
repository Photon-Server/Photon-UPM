namespace Fusion.Addons.InterestManagement
{
	...
	public static class InterestBoxUtility
	{
		...
		/// </summary>
		public static void GetCells(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, HashSet<int> cells)
		{
			if (isAxisAligned == false)
			{
				...
				InterestConeUtility.GetCells(areaOfInterest, position, rotation, coneLength, coneSize, coneSize, coneSize, coneSize, cells);
				return;
			}
		...
		/// </summary>
		public static void DrawGizmo(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, Color color, bool drawIcon = true)
		{
			...
			else
			{
				...
				InterestConeUtility.DrawGizmo(areaOfInterest, position, rotation, coneLength, coneSize, coneSize, coneSize, coneSize, color, false);
			}

			Gizmos.color = gizmoColor;
		}

		[Obsolete("Use GetCells(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, HashSet<int> cells) instead.")]
		public static void GetCells(Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, HashSet<int> cells)
		{
			...
			GetCells(areaOfInterest, position, rotation, size, isAxisAligned, cells);
		}

		[Obsolete("Use DrawGizmo(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, Color color, bool drawIcon) instead.")]
		public static void DrawGizmo(Vector3 position, Quaternion rotation, Vector3 size, bool isAxisAligned, Color color, bool drawIcon = true)
		{
			...
			DrawGizmo(areaOfInterest, position, rotation, size, isAxisAligned, color, drawIcon);
		}
	}
}
