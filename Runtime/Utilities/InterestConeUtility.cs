namespace Fusion.Addons.InterestManagement
{
	...
	public static class InterestConeUtility
	{
		...
		/// </summary>
		public static void GetCells(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize, HashSet<int> cells)
		{
			if (length <= 0.0f)
				return;
			...
			var   gridSize    = areaOfInterest.GetGridSize();
			...
			int   cellSize    = areaOfInterest.GetCellSize();
		...
		/// </summary>
		public static void DrawGizmo(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize, Color color, bool drawIcon = true)
		{
			if (length <= 0.0f)
				return;
			...
			{
				DrawSamplePositions(areaOfInterest, position, rotation, length, startSize, endSize, minSize, maxSize);
			}
		...
		/// </summary>
		public static void DrawSamplePositions(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize)
		{
			if (length <= 0.0f)
				return;
		...
		[Obsolete("Use GetCells(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize, HashSet<int> cells) instead.")]
		...
		{
			if (InterestUtility.TryGetAreaOfInterest(null, out Simulation.AreaOfInterestState areaOfInterest) == false)
				return;

			GetCells(areaOfInterest, position, rotation, length, startSize, endSize, minSize, maxSize, cells);
		}

		[Obsolete("Use DrawGizmo(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize, Color color, bool drawIcon) instead.")]
		public static void DrawGizmo(Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize, Color color, bool drawIcon = true)
		{
			...
			DrawGizmo(areaOfInterest, position, rotation, length, startSize, endSize, minSize, maxSize, color, drawIcon);
		}

		[Obsolete("Use DrawSamplePositions(Simulation.AreaOfInterestState areaOfInterest, Vector3 position, Quaternion rotation, float length, Vector2 startSize, Vector2 endSize, Vector2 minSize, Vector2 maxSize) instead.")]
